  ...
  return (
    <>
      ...
      <div className="container mx-auto px-8 py-8">
        <div className="mb-6">
          {/* Judul */}
          <span className="text-5xl font-bold ">Artikel Kami</span>

          {/* Baris: Deskripsi + Filter */}
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mt-4">
            {/* Deskripsi */}
            <span className="text-lg text-gray-600 max-w-md">
              “Temukan informasi, wawasan, dan inspirasi terkini dalam satu
              tempat baca yang cerdas dan terpercaya.”
            </span>
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <select
                ...
                className={`px-3 py-2 min-w-[150px] border rounded-md cursor-pointer`}
